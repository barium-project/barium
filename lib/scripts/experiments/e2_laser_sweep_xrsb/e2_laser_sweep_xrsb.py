...
class e2_laser_sweep_xrsb(experiment):

    name = 'E2 Laser Sweep XRSB'

    exp_parameters = [
                      ('E2LaserSweepXRSB', 'Sequences_Per_Point'),
                      ('E2LaserSweepXRSB', 'Start_Frequency'),
                      ('E2LaserSweepXRSB', 'Stop_Frequency'),
                      ('E2LaserSweepXRSB', 'Frequency_Step'),
                      ('E2LaserSweepXRSB', 'dc_threshold'),
                      ('E2LaserSweepXRSB', 'HP_Amplitude_spectroscopy'),
                      ('E2LaserSweepXRSB', 'HP_Amplitude_rsb'),
                      ('E2LaserSweepXRSB', 'Mode'),
                      ('E2LaserSweepXRSB', 'exps_to_average'),
                      ('E2LaserSweepXRSB', 'RSB_Frequency'),
                      ]
...
#        self.HPA = self.cxn.hp8672a_server
        ...
        self.cycles = self.p.E2LaserSweepXRSB.Sequences_Per_Point
        self.averages = int(self.p.E2LaserSweepXRSB.exps_to_average)
        self.start_frequency = self.p.E2LaserSweepXRSB.Start_Frequency
        self.stop_frequency = self.p.E2LaserSweepXRSB.Stop_Frequency
        self.step_frequency = self.p.E2LaserSweepXRSB.Frequency_Step
        self.state_detection = self.p.E2LaserSweepXRSB.State_Detection
        self.dc_thresh = self.p.E2LaserSweepXRSB.dc_threshold
        self.hp_amp = self.p.E2LaserSweepXRSB.HP_Amplitude_spectroscopy
        self.hp_amp_rsb = self.p.E2LaserSweepXRSB.HP_Amplitude_rsb
        self.disc = self.pv.get_parameter('StateReadout','state_readout_threshold')
        self.mode = self.p.E2LaserSweepXRSB.Mode
        self.rsb_frequency = self.p.E2LaserSweepXRSB.RSB_Frequency
...
#        loop_iter = 0        
                ...
                while True:
                    ...
                    # otherwise call return to break out of function
                        ...
                        if self.remove_protection_beam():
                            ...
                            self.set_rsb_hp_rf_state(False)
    ...
    def set_up_datavault(self):
        ...
        dataset = self.dv.new('E2LaserSweepXRSB_prob',[('freq', 'MHz')], [('Probability', 'Probability', 'num')], context = self.c_prob)
        # add dv params
...
#        self.dv.add_parameter('1762 Frequency', self.bristol.get_frequency(), context = self.c_prob)
        ...
        dataset1 = self.dv.new('E2LaserSweepXRSB_hist',[('freq', 'MHz')], [('Counts', 'Counts', 'num')], context = self.c_hist)
        # add dv params
        for parameter in self.p:
        ...
        dataset2 = self.dv.new('E2LaserSweepXRSB_dc_hist',[('run', 'arb u')],\
...
if __name__ == '__main__':
    ...
    exprt = e2_laser_sweep_xrsb(cxn = cxn)
