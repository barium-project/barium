...
class MassSpecExperiment_UI(QtGui.QWidget):
    def setupUi(self):
        ...
        self.ms_iterations_spinbox.setGeometry(QtCore.QRect(20, 160, 101, 22))
        ...
        self.label_19.setGeometry(QtCore.QRect(140, 140, 101, 16))
        ...
        self.label_17.setGeometry(QtCore.QRect(260, 140, 111, 16))
        ...
        self.ms_begin_experiment_button.setGeometry(QtCore.QRect(250, 240, 121, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.ms_wait_time_spinbox = QtGui.QDoubleSpinBox(self.frame)
        self.ms_wait_time_spinbox.setGeometry(QtCore.QRect(140, 160, 101, 22))
        self.ms_wait_time_spinbox.setMaximum(5.0)
        self.ms_wait_time_spinbox.setSingleStep(0.1)
        self.ms_wait_time_spinbox.setProperty("value", 1.0)
        self.ms_wait_time_spinbox.setObjectName(_fromUtf8("ms_wait_time_spinbox"))
        ...
        self.label_21.setGeometry(QtCore.QRect(20, 140, 91, 16))
    ...
    def retranslateUi(self):
        ...
        self.label_19.setText(_translate("Form", "Extra Wait Time (s)", None))
        self.label_20.setText(_translate("Form", "Total Count Time", None))
        self.label_17.setText(_translate("Form", "Trigger Frequency (Hz)", None))
        ...
        self.ms_trigger_frequency_spinbox.setToolTip(_translate("Form", "The pulse frequency of the trigger input", None))
