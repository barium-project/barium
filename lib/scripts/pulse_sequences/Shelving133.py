...
class shelving133(pulse_sequence):
    ...
    def sequence(self):
        ...
        if self.shelve_time != 0:
            ...
            self.addTTL(self.ttl_650, self.start + self.cool_time + self.prep_time, self.shelve_time + self.switch_time)
            ...
            self.addTTL(self.ttl_455, self.start + self.cool_time + self.prep_time + self.switch_time, self.shelve_time)
        ...
        self.addDDS(self.channel_493, self.t0 + self.cool_time + self.prep_time + self.switch_time + self.shelve_time, \
                    self.detection_time + self.deshelve_time, self.freq_493, self.amp_493)
        self.addDDS(self.channel_650, self.t0 + self.cool_time + self.prep_time + self.switch_time + self.shelve_time,  self.detection_time + \
        ...
        self.addTTL('ReadoutCount', self.start + self.cool_time + self.prep_time + \
                    self.switch_time + self.shelve_time, self.detection_time)

        # Turn on deshelving LED
        self.addTTL('TTL7', self.start + self.cool_time  + self.shelve_time + self.prep_time \
