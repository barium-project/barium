...
class linescan_camera(experiment):
    ...
    exp_parameters.append(('Linescan_Camera', 'wm_channel_650'))

    exp_parameters.append(('Linescan_Camera', 'Center_Frequency_493'))
    exp_parameters.append(('Linescan_Camera', 'Center_Frequency_650'))
    @classmethod
    ...
    def initialize(self, cxn, context, ident):
        self.ident = ident
        self.cxn = labrad.connect(name = 'Line Scan Camera')
