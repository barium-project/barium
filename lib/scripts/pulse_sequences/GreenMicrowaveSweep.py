...
from sub_sequences.GreenMicrowaves133 import green_microwaves_133
...
class green_microwave_sweep(pulse_sequence):
    ...
    required_subsequences = [doppler_cooling_133, state_prep_133, green_microwaves_133, composite_1, \
    ...
    def sequence(self):
        ...
        if p.microwave_pulse_sequence == 'single':
            self.addSequence(green_microwaves_133)
