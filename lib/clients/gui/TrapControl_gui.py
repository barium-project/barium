...
class QCustomTrapGui(QtGui.QFrame):
    ...
    def makeLayout(self):
        ...
        freqName = QtGui.QLabel('Frequency (Hz)')
        ...
        self.spinDC1.setDecimals(1)
        self.spinDC1.setSingleStep(.1)
        ...
        self.spinDC2.setDecimals(1)
        self.spinDC2.setSingleStep(.1)
        ...
        self.spinDC3.setDecimals(1)
        self.spinDC3.setSingleStep(.1)
        ...
        self.spinDC4.setDecimals(1)
        self.spinDC4.setSingleStep(.1)
        ...
        self.spinEndCap1.setDecimals(1)
        self.spinEndCap1.setSingleStep(.1)
        self.spinEndCap1.setRange(0, 53)
        ...
        self.spinEndCap2.setDecimals(1)
        self.spinEndCap2.setSingleStep(.1)
