...
class microwave_fidelity(pulse_sequence):
    ...
    required_parameters = [
                           ('MicrowaveFidelity', 'microwave_pulse_sequence'),
                           ('MicrowaveFidelity','State_Detection'),
                           ('MicrowaveFidelity','number_of_microwave_pulses'),
                           ('MicrowaveFidelity','zeeman_pulse'),
                           ]
    ...
    def sequence(self):
        ...
        p = self.parameters.MicrowaveFidelity
        ...
        if p.zeeman_pulse == 'True':
            self.addSequence(microwaves_133) # Pi pulse back on zeeman state
